...
drawUniverse images u = pictures
  ...
  , drawBonuses   [blank, (imageB_oil images), (imageB_low images), (imageB_high images), (imageB_gun images), 
                          (imageB_def images), (imageB_clear images), (imageB_barrier images)] (bonuses u)  
  ] 
  ++ drawSpaceships (imageSpaceship images) (imageShield images) [blank,(imageB_low images), (imageB_high images), 
        (imageB_gun images), (imageB_def images), (imageB_clear images), (imageB_barrier images)] (spaceships u)
